...
from summary_app.api.documents.endpoints.documents import ns as documents_namespace
from summary_app.api.documents.endpoints.summaries import ns as summaries_namespace
